...
export type GetHotelsQuery = { categoriesConnection: { edges: Array<{ node: { id: string, name: string, publishedAt?: unknown | null, slug: string, updatedAt: unknown, publishedBy?: { name: string } | null } }> } };
...
export const GetHotelsDocument = new TypedDocumentString(`
    query getHotels {
  categoriesConnection {
    ...
    `) as unknown as TypedDocumentString<GetHotelsQuery, GetHotelsQueryVariables>;